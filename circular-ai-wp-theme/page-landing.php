...
<div class="marquee-container">
    <div class="marquee">
        ...
        <span class="marquee-item" aria-hidden="true"><?php echo esc_html($item['icon'] ?: '✦'); ?> <?php echo esc_html($item['text']); ?></span>
        <?php endforeach; ?>
    </div>
</div>
<?php endif; ?>
...
<section class="hero">
    ...
    <div class="hero-right">
        <!-- Notificaciones flotantes ESTÁTICAS -->
        <?php foreach ($static_notifications as $notif) : ?>
        <div class="notification <?php echo esc_attr($notif['class']); ?>">
...
<!-- Content Blocks -->
<?php
$content_blocks = circular_ai_get_field('content_blocks', $page_id);
if ($content_blocks) :
    foreach ($content_blocks as $block) :
        ...
        if ($layout === 'text_image') :
            ...
            $section_class = $image_position === 'left' ? 'text-image-left' : 'text-image-right';
?>
                ...
                <div class="container">
                    <div class="content-grid">
                        <div class="content-text">
                            ...
                            <p><?php echo nl2br(esc_html($block['text'])); ?></p>
                        </div>
                        <?php if ($block['image']) : ?>
...
?>
            <section class="content-section features-section">
                <div class="container">
                    <h2 class="section-title"><?php echo esc_html($block['section_title']); ?></h2>
            ...
            <section class="content-section cta-section">
                <div class="container">
                    <div class="cta-box">
                        ...
                        <a href="<?php echo esc_url($block['button_url']); ?>" class="btn-cta">
